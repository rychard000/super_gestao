    ...
    <div class="conteudo-pagina">
        ...
        <div class="informacao-pagina">
            <div style="width:90%; margin-left:auto; margin-right:auto;">
                    ...
                    <tbody>
                        @foreach ($produtos as $produto)
                            <tr>
                                ...
                                {{-- agora o produto tem a instancia dentro dele de produto_detalhes atraves da chave e pela funcao hasOne
                                que coloquei na funcao do model do mesmo --}}
                ...
                <br>
                {{$produtos->firstItem()}} - Numero do ultimo registro da pagina
